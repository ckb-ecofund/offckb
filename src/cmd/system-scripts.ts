...
import { CellDepInfoLike, DepType, HashType, KnownScript, Script } from '@ckb-ccc/core';
...
export type SystemScriptsRecord = Record<SystemScriptName, SystemScript>;
...
export function toLumosConfig(scripts: SystemScriptsRecord) {
